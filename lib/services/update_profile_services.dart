...
class UpdateProfileServices {
  ...
  Future<RegisterResponseModel?> updateProfile({
    required String firsName,
    required String lastName,
    required String eMail,
  }) async {
    try {
      var url = Uri.parse('${Globals.apiBaseUrl}account/updateProfile');
      ...
      if (result.statusCode == 200) {
        ...
        isTokenValid = true;
        log("Profili Düzenle Token Aktiflik Durumu $isTokenValid");
