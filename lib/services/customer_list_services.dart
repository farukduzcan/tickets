...
import 'package:tickets/models/customer_list_model.dart';
...
class CustomerListServices {
  ...
  Future<CustomerListModel?> getCustomerList({
    ...
    try {
      var url = Uri.parse('${Globals.apiBaseUrl}client/customer/list');
      ...
      if (result.statusCode == 200) {
        ...
        isTokenValid = true;
        log("Customer List Token Aktiflik Durumu $isTokenValid");
        // print("token valid mi $isTokenValid");
        var resultJson = CustomerListModel.fromJson(json.decode(result.body));
        return resultJson;
      }
      ...
      return CustomerListModel.fromJson(json.decode(result.body));
    } on SocketException {
