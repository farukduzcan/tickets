...
class _TicketStatusListBodyState extends State<TicketStatusListBody> {
                          ...
                          if (index < snapshot.data!.datas.length) {
                                    ...
                                    subtitle: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            "\n${TicketConstant.createdUser}: ${snapshot.data!.datas[index].createUserName!}",
                                            maxLines: 2,
                                            overflow: TextOverflow.ellipsis,
                                            style: const TextStyle(
                                              color: Colors.black,
                            ...
                            return Center(
                              child: Padding(
                                ...
                                child: Text(
                                    "${ErrorMessagesConstant.endPage} ${snapshot.data!.datas.length} /${snapshot.data!.totalItemsCount}"),
                              ),
                            );
                          } else {
